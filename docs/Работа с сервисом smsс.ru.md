...
# Работа с сервисом smsc.ru

## Рассмотрим работу с обработкой на примере сервиса smsc.ru  
...
Первым делом перейдем на вкладку **"Доступ на сайт"** и в поле **"Сервис"** выберем `"smsc.ru"`

![Выбор сервиса](static/01_smsc.png)
...
![Заполнение параметров](static/02_smsc.png)
