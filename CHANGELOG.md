...
* Изменение алгоритма отпраавки SMS  для оператора sms-prosto 

# [1.0.0.52] - 2022-08-31

## Изменения:

*Редактироавние списка поддерживаемых провайдеров

# [1.0.0.51] - 2022-08-31

## Изменения:

* Добавлен  СМС сервис от ProstoSMS.
...
* Исправлена ошибка при формировании статуса сообщения для сервиса terasms
